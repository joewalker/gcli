...
var stylizerCommandSpec = {
  ...
  params: [
   ...
   returnType: 'html',
   exec: function(args, context) {
     return l10n.lookup('stylizer_reply', { node: '' + args.node }) +
         getBugLink(683502);
   }
};
...
var highlightCommandSpec = {
  ...
  params: [
   ...
   returnType: 'html',
   exec: function(args, context) {
     return l10n.lookup('highlight_reply', { node: '' + args.node }) +
         getBugLink(683506);
   }
};
...
var inspectCommandSpec = {
  ...
  params: [
   ...
   returnType: 'html',
   exec: function(args, context) {
     return l10n.lookup('inspect_reply', { node: '' + args.node }) +
         getBugLink(683508);
   }
};
...
var doctorCommandSpec = {
  ...
  params: [
   ...
   returnType: 'html',
   exec: function(args, context) {
     return l10n.lookup('doctor_reply', { node: '' + args.node }) +
         getBugLink(683509);
   }
};
...
var scratchpadCommandSpec = {
  ...
  exec: function(args, context) {
    ...
    if (args.file) {
      return '<textarea rows=5 cols=80 style="font-family:monospace">' +
          l10n.lookup('scratchpad_filepretend', { file: args.file }) +
          '</textarea>' +
          getBugLink(683513);
    }
    if (args.script) {
