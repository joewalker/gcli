...
exports.testSimpleHistory = function () {
  ...
  history.add('foo');
  history.add('bar');
  t.verifySame('bar', history.backward());
  t.verifySame('foo', history.backward());

  // Adding to the history again moves us back to the start of the history.
  history.add('quux');
  t.verifySame('quux', history.backward());
  t.verifySame('bar', history.backward());
  t.verifySame('foo', history.backward());
};
...
exports.testForwardsPastIndex = function () {
  ...
  t.verifySame('bar', history.forward());

  // 'Present' time.
  t.verifySame('', history.forward());
