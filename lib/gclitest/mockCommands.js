...
mockCommands.setup = function(opts) {
  ...
  types.registerType(mockCommands.SlowNumType);
  ...
  canon.addCommand(mockCommands.tsslow);
};
...
mockCommands.shutdown = function(opts) {
  ...
  canon.removeCommand(mockCommands.tsslow);

  types.deregisterType(mockCommands.SlowNumType);
...
mockCommands.SlowNumType = SlowSelType;
