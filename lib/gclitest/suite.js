...
define(function(require, exports, module) {
  ...
  examiner.addSuite('gclitest/testAsync', require('gclitest/testAsync'));
  ...
  examiner.addSuite('gclitest/testContext', require('gclitest/testContext'));
  examiner.addSuite('gclitest/testDate', require('gclitest/testDate'));
  examiner.addSuite('gclitest/testExec', require('gclitest/testExec'));
  examiner.addSuite('gclitest/testFail', require('gclitest/testFail'));
  examiner.addSuite('gclitest/testFile', require('gclitest/testFile'));
  examiner.addSuite('gclitest/testFileparser', require('gclitest/testFileparser'));
  examiner.addSuite('gclitest/testFilesystem', require('gclitest/testFilesystem'));
  ...
  examiner.addSuite('gclitest/testKeyboard1', require('gclitest/testKeyboard1'));
  examiner.addSuite('gclitest/testKeyboard2', require('gclitest/testKeyboard2'));
  examiner.addSuite('gclitest/testKeyboard3', require('gclitest/testKeyboard3'));
  ...
  examiner.addSuite('gclitest/testRemote', require('gclitest/testRemote'));
  ...
  examiner.addSuite('gclitest/testShort', require('gclitest/testShort'));
  ...
  examiner.addSuite('gclitest/testString', require('gclitest/testString'));
