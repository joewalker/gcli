...
function checkOptions(options) {
  ...
  if (options.terminal == null) {
    console.trace();
    throw new Error('options object does not contain a terminal property');
  }
...
helpers.setInput = function(options, typed, cursor) {
  ...
  return inputPromise.then(function() {
    ...
    options.terminal.focusManager.onInputChange();
...
helpers.audit = function(options, audits) {
  ...
  return util.promiseEach(audits, function(audit) {
    ...
    return options.terminal.setInput('');
  });
};
