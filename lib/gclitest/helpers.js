...
exports.status = function(options, checks) {
  ...
  if (checks.emptyParameters != null) {
    if (Array.isArray(checks.emptyParameters)) {
      var actualParams = data.emptyParameters;
      ...
      test.is(data.emptyParameters.join('').replace(/\u00a0/g, ' '),
...
exports.check = function(checks) {
  ...
  if (checks.emptyParameters != null) {
    if (Array.isArray(checks.emptyParameters)) {
      ...
      test.is(actual.emptyParameters.join('').replace(/\u00a0/g, ' '),
              checks.emptyParameters,
              'emptyParameters');
    }
  }
