  ...
  helpers.audit([
    {
      name: 'tss<TAB>',
      setup: function() {
        return helpers.setInput('tss').then(function() {
          return helpers.pressTab();
        });
      },
      check: {
...
exports.testCompleteIntoOptional = function(options) {
  ...
  helpers.audit([
    ...
    },
    {
      name: 'tso<TAB>',
      setup: function() {
        return helpers.setInput('tso').then(function() {
          return helpers.pressTab();
        });
      },
      check: {
