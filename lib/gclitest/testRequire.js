...
exports.testWorking = function() {
  ...
  t.verifySame('thing1', requireable.thing1);
  t.verifySame(2, requireable.thing2);
...
exports.testDomains = function() {
  ...
  t.verifySame(null, requireable.getStatus());
  t.verifyUndefined(requireable.status);
  requireable.setStatus('42');
  t.verifySame('42', requireable.getStatus());
  t.verifyUndefined(requireable.status);
  ...
  if (define.Domain) {
    ...
    t.verifySame('initial', requireable2.getStatus());
    requireable2.setStatus(999);
    t.verifySame(999, requireable2.getStatus());
    t.verifyUndefined(requireable2.status);
