...
function forEachType(typeSpec, callback) {
  types.getTypeNames().forEach(function(name) {
    typeSpec.name = name;
    typeSpec.requisition = helpers.options.display.requisition;
...
exports.testDefault = function() {
  if (helpers.options.isJsdom) {
    assert.skip('Skipping tests due to issues with resource type.');
    return;
  }
...
exports.testNullDefault = function() {
