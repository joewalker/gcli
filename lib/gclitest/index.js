...
exports.createDisplay = function(options) {
  ...
  window.setTimeout(function() {
    ...
    if (window.location.href.indexOf('shutdown=true')) {
      shutdownServer().then(closeIfPhantomJs, closeIfPhantomJs);
      return;
    }
...
/**
 * Our phantom-test.js script calls phantom.exit() when we set
 * `document.complete = true`. There are probably better ways, but this works
 */
function closeIfPhantomJs() {
  if (isPhantomjs) {
