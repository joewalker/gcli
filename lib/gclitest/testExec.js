...
exports.setup = function(options) {
  // We need to re-register the mockCommands to allow the 'tse' command to be
  // tested properly
  mockCommands.setup();
};
...
exports.testWithHelpers = function() {
  return helpers.audit([
    {
      skipIf: helpers.reason.jsdom,
      setup:    'tss',
      check: {
        input:  'tss',
        hints:     '',
  ...
  return helpers.audit([
    ...
    },
    {
      ...
      check: {
        ...
        args: {
          command: { name: 'tsr' },
          text: { value: 'fred bloggs', arg: ' fred bloggs', status: 'VALID', message: '' },
        }
      },
      exec: {
...
exports.testExecBoolean = function() {
  return helpers.audit([
    {
      setup:    'tsb',
      check: {
        ...
        args: {
          command: { name: 'tsb' },
          toggle: { value: false, arg: '', status: 'VALID', message: '' },
        }
      },
      exec: {
    ...
    },
    {
      ...
      check: {
        ...
        args: {
          command: { name: 'tsb' },
          toggle: { value: true, arg: ' --toggle', status: 'VALID', message: '' },
        }
      },
      exec: {
...
exports.testExecNumber = function() {
  return helpers.audit([
    {
      setup:    'tsu 10',
      check: {
...
exports.testExecScript = function() {
  return helpers.audit([
    {
      ...
      check: {
        ...
        args: {
          command: { name: 'tsj' },
          javascript: { value: '1 + 1', arg: ' { 1 + 1 }', status: 'VALID', message: '' },
        }
      },
      exec: {
...
exports.testExecSubCommand = function() {
  return helpers.audit([
    {
      setup:    'tsn dif fred',
      check: {
...
exports.testExecArray = function() {
  return helpers.audit([
    {
      setup:    'tselarr 1',
      check: {
...
exports.testExecMultiple = function() {
  return helpers.audit([
    {
      setup:    'tsm a 10 10',
      check: {
...
exports.testExecDefaults = function() {
  return helpers.audit([
    {
