...
exports.testIncompleteSingleMatch = function() {
  ...
  t.verifySame('tselarr', assignC.getPredictions()[0].name);
...
exports.testTsv = function() {
  ...
  t.verifySame(commands.option1, assignC.getPredictions()[0].value);
  t.verifySame(commands.option2, assignC.getPredictions()[1].value);
  t.verifySame('tsv', requ.commandAssignment.getValue().name);
