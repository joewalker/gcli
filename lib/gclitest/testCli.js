...
exports.testBlank = function() {
  var requisition = helpers.options.display.requisition;
...
exports.testTsv = function() {
  return helpers.audit([
    ...
    },
    {
      name: '|tsv option',
      setup: function() {
        return helpers.setInput('tsv option', 0);
      },
      check: {
        input:  'tsv option',
        hints:            ' <optionValue>',
...
exports.testElementDom = function() {
  return helpers.audit([
    {
      ...
      check: {
        ...
        args: {
          command: { name: 'tse' },
          node: {
            value: helpers.options.window.document.documentElement,
            arg: ' :root',
            status: 'VALID',
            message: ''
          },
...
exports.testElementWeb = function() {
  var inputElement = helpers.options.window.document.getElementById('gcli-input');

  return helpers.audit([
    {
      skipIf: function gcliInputElementExists() {
        return inputElement == null || helpers.reason.jsdom();
      },
...
exports.testNestedCommand = function() {
  return helpers.audit([
    ...
    {
      skipIf: helpers.reason.phantomjs,
      setup:    'tsn x',
      check: {
        input:  'tsn x',
        hints:       ' -> tsn ext',
