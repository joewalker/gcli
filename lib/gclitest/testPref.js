...
exports.testPrefShowStatus = function(options) {
  ...
  if (canon.getCommand('pref') == null) {
    assert.log('Skipping testPrefShowStatus; missing pref command.');
    return;
  }
...
exports.testPrefSetStatus = function(options) {
  ...
  if (canon.getCommand('pref') == null) {
    assert.log('Skipping testPrefSetStatus; missing pref command.');
    return;
  }
...
exports.testPrefExec = function(options) {
  ...
  if (canon.getCommand('pref') == null) {
    assert.log('Skipping testPrefExec; missing pref command.');
    return;
  }
