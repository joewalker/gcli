...
exports.testScript = function() {
  return helpers.audit([
    {
      skipIf: helpers.reason.createComandCheck('{'),
      setup: '{ wind<TAB>',
      check: { input: '{ window' }
    },
    {
...
exports.testIncrSelection = function() {
  /*
...
exports.testDecrSelection = function() {
  /*
  // Bug 829516:  GCLI up/down navigation over selection is sometimes bizarre
  return helpers.audit([
    {
