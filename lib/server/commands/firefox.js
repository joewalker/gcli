 ...
 * Consists of: GcliModules.jsm, GcliChromeModules, browser_gcli_web.js and gcli.properties
 */
exports.buildFirefox = function(destDir) {
  ...
  // Package GcliModules.jsm
  copy({
    source: [
      'mozilla/build/module-prefix.jsm',
      // This list of dependencies should be the same as in Gcli.jsm
