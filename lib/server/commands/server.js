 ...
 */
var host = main.require('gcli/util/host');
var fileparser = main.require('gcli/util/fileparser');
var xhr = main.require('gcli/util/xhr');
      ...
      socket.on('execute', function(data) {
        ...
        requisition.update(data.typed).then(function() {
          if (requisition.status !== Status.VALID) {
            ...
            return requisition.exec().then(function(output) {
              try {
                socket.emit('executed', {
                  requestId: data.requestId,
                  data: output.data,
