...
exports.testCli = function() {
    ...
    verifyPredictionsContains('historyLength', assignC.getPredictions());
    test.verifyEqual('tsv', requ.commandAssignment.getValue().name);
    test.verifyEqual('historyLengt', assign1.getArg().text);
    test.verifyEqual(undefined, assign1.getValue());
    ...
    test.verifyEqual('tsv', requ.commandAssignment.getValue().name);
    test.verifyEqual('historyLength', assign1.getArg().text);
    test.verifyEqual(historyLengthSetting, assign1.getValue());
    test.verifyEqual(0, assignC.paramIndex);
