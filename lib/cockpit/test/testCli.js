...
exports.testCli = function() {
    ...
    function update(input) {
        ...
        display = cli.getAssignmentAt(input.cursor.start, false).getHint();
        prev = cli.getAssignmentAt(input.cursor.start, true);
    ...
    test.verifyEqual(Status.VALID, display.status);
    test.verifyEqual(0, display.start);
    //test.verifyEqual(2, display.end);
    test.verifyEqual('tsv', cli.commandAssignment.value.name);
    ...
    test.verifyEqual(Status.ERROR, worst.status);
    ...
    test.verifyEqual(null, cli.unassigned);
    ...
    test.verifyEqual('EEEEVVVV', statuses);
    test.verifyEqual('fred', cli.commandAssignment.arg.text);
    test.verifyEqual('one', cli.unassigned.text);
    ...
    test.verifyEqual(Status.ERROR, display.status);
    test.verifyEqual('tsu', cli.commandAssignment.value.name);
