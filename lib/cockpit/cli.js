...
Argument.prototype = {
     ...
     * <tt>replacementText</tt> and the end adjusted to fit
     */
    beget: function(replacementText) {
        return new Argument(
            replacementText,
            this.start,
            this.end - this.text.length + replacementText.length,
            this.prefix,
            this.suffix);
    },
...
Assignment.prototype = {
    ...
    setArgument: function(arg) {
        if (Argument.equals(this.arg, arg)) {
            return;
        }
...
Requisition.prototype = {
    ...
    _onAssignmentChange: function(ev) {
        if (this.structuralChangeInProgress) {
            return;
        }
     ...
     */
    _onCommandAssignmentChange: function() {
        this._assignments = {};
...
(function() {
    ...
    CliRequisition.prototype.getInputStatusMarkup = function() {
        ...
        function updateStatuses(status, arg) {
            ...
            var startInArg = c.start >= start && c.start <= end;
            var endInArg = c.end >= start && c.end <= end;
