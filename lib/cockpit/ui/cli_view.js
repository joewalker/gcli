    ...
    createElements: function() {
        ...
        hideOutput = (function() {
            if (preventBlurTimer) {
                ...
                !preventBlurInputFocus && setTimeout(function() {
                    input.focus();
                }, 0);
                return;
            } else {
                ...
                outputHideTimer = setTimeout(function() {
        ...
        preventBlur = (function(e) {
            ...
            if (e) {
                // If this function was called by a event, check if the element
                // that was clicked/focused has a blur event. If so, setting
                // preventBlurInputFocus disallow hideOutput() to focus the
                // input element.
            ...
            // occurred sometimes before the input.blur event, but the input.blur
            // event should be prevented.
            preventBlurTimer && clearTimeout(preventBlurTimer);
            preventBlurTimer = setTimeout(function() {
                preventBlurTimer = null;
                preventBlurInputFocus = false;

                // If bluring was prevented due to selecting/focusing a check
        ...
        // If any of the DOM nodes inside of output get blured, hide the
