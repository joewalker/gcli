...
CliView.prototype = {
    ...
    createElements: function() {
        ...
        var li = this.onCommandAssignmentChange.bind(this);
        this.cli.commandAssignment.addEventListener('assignmentChange', li);

        li = this.onInputChange.bind(this);
        this.cli.addEventListener('inputChange', li);
    },
     ...
     */
    onCommandAssignmentChange: function(ev) {
...
TextField.prototype.createElement = function(assignment) {
    ...
    this.input.addEventListener('keyup', function() {
        var arg = assignment.arg.beget(this.input.value);
        assignment.setArgument(arg);
    }.bind(this), false);

    assignment.addEventListener('assignmentChange', function() {
        this.input.value = assignment.arg.text;
    }.bind(this));
