...
Field.prototype.createElement = function(assignment) {
...
TextField.prototype.createElement = function(assignment) {
    ...
    this.setValue(assignment.value);

    this.input.addEventListener('keyup', this.onKeyup, false);

    return this.input;
};
TextField.prototype.onKeyup = function(ev) {
...
Field.prototype.setValue = function(value) {
    this.input.value = (value == null) ? '' : this.type.stringify(value);
};
...
SelectionField.prototype.createElement = function(assignment) {
    ...
    var defaultText = 'Select a ' + assignment.param.name + ' ...';
    this.addOption(null, defaultText, SelectionField.DEFAULT_VALUE);

    this.assignment.getPredictions().forEach(function(prediction) {
        this.addOption(prediction, prediction.name);
    }, this);
...
SelectionField.prototype.onChange = function() {
    this._dispatchEvent('change', ev);
};
SelectionField.prototype.getValue = function() {
    return this.select.value === SelectionField.DEFAULT_VALUE ?
            null :
            this.opts[this.select.value].value;
};
SelectionField.prototype.setValue = function(value) {
    ...
    this.select.value = optValue;
};
SelectionField.prototype.addOption = function(value, optText, optValue) {
    this.opts[optValue] = {
        value: value,
        optText: optText,
        optValue: optValue
...
SelectionField.prototype.destroy = function() {
    this.select.removeEventListener('change', this.onChange, false);
};
...
ArrayField.prototype.createElement = function(assignment) {
    this.assignment = assignment;

    this.type = assignment.param.type;
    ...
    */
    ...
    if (assignment.arg) {
        assignment.arg.value.forEach(function(value) {
            this.onAppendElement(null, value);
        }, this);
    }


    this.onKeyup = function() {
        this.assignment.setValue(this.parent.value);
    }.bind(this);
    this.parent.addEventListener('keyup', this.onKeyup, false);

    this.onAsmtChange = function() {
        this.parent.value = this.assignment.arg.text;
    }.bind(this);
    this.assignment.addEventListener('assignmentChange', this.onAsmtChange);

    return this.parent;
};
ArrayField.prototype.onAppendElement = function(value) {
    var field = getField(this.doc, this.type);
    this.fields.push(field);
    var element = field.createElement(assignment);
    field.addEventListener('change', function(ev) {

    }.bind(this));
};
ArrayField.prototype.destroy = function() {
    this.parent.removeEventListener('keyup', this.onKeyup, false);
