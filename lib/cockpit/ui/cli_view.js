...
NumberField.claim = function(type) {
    return type.name === 'number' ? Field.MATCH : Field.IF_NOTHING_BETTER;
};
...
function ArrayField(doc, type) {
    ...
    var clone = ArrayField.arrayTmpl.cloneNode();
    new Templater().processNode(clone, this);
