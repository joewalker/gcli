...
CliView.prototype = {
    ...
    getInputFor: function(assignment) {
        ...
        if (assignment.param.type instanceof SelectionType) {
            ...
            input.addEventListener('keyup', function() {
                assignment.setText(input.value);
                this.update();
            }.bind(this), false);
        }

        var listener = this.onAssignmentChange.bind(this);
        assignment.addEventListener('assignmentChange', listener);
     ...
     */
    onAssignmentChange: function(ev) {
console.log('ev=', ev);
        if (this.isUpdating) {
            return;
        }
        ...
        var argStart = ev.assignment.arg.start;
        var argEnd = ev.assignment.arg.end;
        ...
        var inserted = ev.assignment.arg.text;
