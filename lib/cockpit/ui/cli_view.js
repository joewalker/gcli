...
var TextType = require('pilot/types/basic').TextType;
...
CliView.prototype = {
    ...
    getInputFor: function(assignment) {
        var field = getField(this.doc, assignment.param.type, this.cli);

        // TODO remove on delete
        field.addEventListener('change', function() {
            assignment.setValue(field.getValue());
        });
...
Field.prototype.getValue = function() {
    // return this.type.parseString(this.element.value).value;
    throw new Error('Field should not be used directly');
};

Field.prototype.setValue = function(value) {
    // this.element.value = this.type.stringify(value);
    throw new Error('Field should not be used directly');
};
...
function getField(doc, type, cli) {
    var ctor;
    var highestClaim = -1;
 ...
 *
 */
function TextField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
...
TextField.claim = function(type) {
    return type instanceof TextType ? Field.MATCH : Field.IF_NOTHING_BETTER;
};
 ...
 *
 */
function NumberField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
 ...
 *
 */
function BooleanField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
 ...
 * </ul>
 */
function SelectionField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
    this.opts = {};
 ...
 *
 */
function DeferredField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
    this.cli = cli;
    ...
    this.cli.addEventListener('assignmentChange', this.onCliChange);
...
DeferredField.prototype.destroy = function() {
    this.cli.removeEventListener('assignmentChange', this.onCliChange);
};

DeferredField.prototype.getValue = function() {
    return this.field.getValue();
};

DeferredField.prototype.setValue = function(value) {
 ...
 *
 */
function BlankField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
    this.element = this.doc.createElement('div');
}
...
BlankField.prototype.getValue = function() { return null; };
BlankField.prototype.setValue = function(value) { };
 ...
 *
 */
function ArrayField(doc, type, cli) {
    this.doc = doc;
    this.type = type;
    ...
    this.mbrElement = this.doc.createElement('div');
    this.mbrElement.className = 'cptArrayMbrs';
    this.element.appendChild(this.mbrElement);
}
...
ArrayField.prototype.getValue = function() {
    return this.members.map(function(member) {
        return member.field.getValue();
    }, this);
};

ArrayField.prototype._onAdd = function(ev, value) {

    // <div class=cptArrayMbr save="${element}">
    var element = this.doc.createElement('div');
    element.className = 'cptArrayMbr';
    this.mbrElement.appendChild(element);
    ...
    member.onDelete = function() {
        this.mbrElement.removeChild(this.element);
        var value = this.field.getValue();
        this.parent._dispatchEvent('change', {});
 ...
 */
(function() {
    var cliViewHtml = require('text!cockpit/ui/field.html');
    var templates = document.createElement('div');
    templates.innerHTML = cliViewHtml;
    ArrayField.arrayTmpl = templates.querySelector('#cptArrayTmpl');
})();
