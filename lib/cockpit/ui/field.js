...
Field.prototype.setConversion = function(conversion) {
    // this.element.value = conversion.value;
    throw new Error('Field should not be used directly');
};
...
TextField.prototype.setConversion = function(conversion) {
    this.arg = conversion.arg;
    this.element.value = conversion.getText();
    this.setMessage(conversion.message);
};
...
function BooleanField(doc, type, cli) {
    ...
    this.onChange = function() {
        var conversion = new Conversion(this.element.checked);
        this._dispatchEvent('change', { conversion: conversion });
        this.setMessage('');
    }.bind(this);
...
function SelectionField(doc, type, cli) {
    ...
    this.onChange = function(ev) {
        ...
        this._dispatchEvent('change', { conversion: conversion });
        this.setMessage(conversion.value == null ? 'Missing value' : '');
    }.bind(this);
    this.element.addEventListener('change', this.onChange, false);
}
...
ArrayField.prototype.setConversion = function(conversion) {
    if (conversion.value) {
        conversion.value.forEach(function(item) {
...
ArrayField.prototype._onAdd = function(ev, value) {
    ...
    field.addEventListener('change', function() {
        var value = this.members.map(function(member) {
            return member.field.getConversion();
        }, this);
        var conversion = new Conversion(value);
        this._dispatchEvent('change', { conversion: conversion });
        this.setMessage('');
    }.bind(this));
    if (value) {
