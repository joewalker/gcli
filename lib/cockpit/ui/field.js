...
define(function(require, field, module) {
...
var ArrayConversion = require('cockpit/types').ArrayConversion;

var StringType = require('cockpit/types').StringType;
var NumberType = require('cockpit/types').NumberType;
var BooleanType = require('cockpit/types').BooleanType;
var BlankType = require('cockpit/types').BlankType;
var SelectionType = require('cockpit/types').SelectionType;
var DeferredType = require('cockpit/types').DeferredType;
