...
define(function(require, requestView, module) {
...
function RequestView(request, cliView) {
    ...
    this.cliView.requests.appendChild(this.rowin);
    this.cliView.requests.appendChild(this.rowout);
...
RequestView.prototype = {
    ...
    executeRequest: function(ev) {
        this.cliView.requ.update({
            typed: this.request.typed,
            cursor: { start:0, end:0 }
        });
        this.cliView.requ.exec();
    },
