...
var gcliOneDate = {
  ...
  returnType: 'html',
  exec: function(args, context) {
    return motivate() + 'date=' + args.date;
  }
};
...
var gcliTwoDates = {
  ...
  returnType: 'html',
  exec: function(args, context) {
    return motivate() + 'date1=' + args.date1 + ' date2=' + args.date2;
  }
};
...
exports.startup = function() {
  ...
  gcli.addCommand(gcliOneDate);
  gcli.addCommand(gcliTwoDates);
};
...
exports.shutdown = function() {
  ...
  gcli.removeCommand(gcliOneDate);
  gcli.removeCommand(gcliTwoDates);
};
