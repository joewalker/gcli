...
var gcliCommandSpec = {
    ...
    exec: function(env, args) {
        ...
        return 'GCLI ' + messages[index];
    }
};
var messages = [
    'really wants you to trick it out in some way.',
    'is your Web command line.',
    'would love to be like Zsh on the Web.',
...
exports.startup = function() {
    ...
    gcli.addCommand(gcliCommandSpec);
...
exports.shutdown = function() {
    ...
    gcli.removeCommand(gcliCommandSpec);
