 ...
 *   };
 *
 *   var handle = getRemoteHandle(example.greet, greet, 'Fred');
 *
 *   // later
 *
 *   callRemoteHandle(handle, 'Blogs');  // 'Hello, Fred Blogs'
 */
exports.getRemoteHandle = function(func, scope, args) {
...
exports.callRemoteHandle = function(id, args) {
...
exports.removeRemoteHandle = function(id) {
