 ...
 */
var commandHtmlPromise = host.staticRequire(module, './command.html');
...
var commandLanguage = exports.commandLanguage = {
  ...
  constructor: function(terminal) {
    ...
    if (this.requisition == null) {
      ...
      environment.document = environment.document || options.document || this.document;
