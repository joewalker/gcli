...
/**
 * CommandLanguage (like other language implementations) drives a Terminal to
 * allow input and show the results of the input. Each Control class represents
 * a language. CommandLanguage supports GCLI commands.
 */
function CommandLanguage(options) {
  ...
  if (this.requisition == null) {
    ...
    environment.document = environment.document || options.document;
    environment.window = environment.window || environment.document.defaultView;

    this.requisition = new Requisition(environment, options.document || document);
  }
  ...
  cli.addMapping(this.requisition, this.terminal);
}

/**
 * Avoid memory leaks
 */
CommandLanguage.prototype.destroy = function() {
  cli.removeMapping(this.requisition, this.terminal);
 ...
 */
Object.defineProperty(CommandLanguage.prototype, 'description', {
  get: function() {
 ...
 */
Object.defineProperty(CommandLanguage.prototype, 'message', {
  get: function() {
 ...
 */
CommandLanguage.prototype.textChanged = function() {
 ...
 */
CommandLanguage.prototype.caretMoved = function(start) {
 ...
 */
CommandLanguage.prototype.updateHints = function() {
  this.lastText = this.assignment.arg.text;
 ...
 */
CommandLanguage.prototype.handleUpArrow = function() {
 ...
 */
CommandLanguage.prototype.handleDownArrow = function() {
  if (this.assignment.getStatus() === Status.VALID) {
 ...
 */
CommandLanguage.prototype.handleReturn = function() {
 ...
 * input element.
 */
CommandLanguage.prototype.handleTab = function() {
 ...
 */
CommandLanguage.prototype.handleInput = function(value) {
 ...
 */
CommandLanguage.prototype.setCursor = function(cursor) {
 ...
 */
CommandLanguage.prototype._processCaretChange = function(input) {
  var start, end;
 ...
 */
CommandLanguage.prototype.getCompleterTemplateData = function() {
  var input = this.terminal.getInputState();
 ...
 */
CommandLanguage.prototype.fieldChanged = function(ev) {
 ...
 */
CommandLanguage.prototype.outputted = function(ev) {
  if (ev.output.hidden) {
    return;
  }
 ...
 */
CommandLanguage.prototype._linksToNewTab = function(element) {
 ...
 */
CommandLanguage.prototype.showIntro = function() {
  intro.maybeShowIntro(this.requisition.commandOutputManager,
                       this.requisition.conversionContext);
};

CommandLanguage.prototype.item = 'language';

CommandLanguage.shortname = 'commands';

exports.CommandLanguage = CommandLanguage;
