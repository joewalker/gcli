...
var baseLanguage = {
  ...
  handleReturn: function() {
    throw new Error('Missing implementation of handleReturn in ' + this.name);
  }
};
 ...
 */
exports.createLanguage = function(name, terminal, options) {
  if (name == null) {
  ...
  // clone 'type'
  var newInstance = {};
  copyProperties(baseLanguage, newInstance);
  copyProperties(language, newInstance);

  if (typeof newInstance.constructor === 'function') {
    var reply = newInstance.constructor(terminal, options);
