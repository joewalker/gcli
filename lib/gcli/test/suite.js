...
exports.init = function(isNode) {
  ...
  examiner.addSuite('testCli1', require('./testCli1'));
  examiner.addSuite('testCli2', require('./testCli2'));
  examiner.addSuite('testCompletion1', require('./testCompletion1'));
  examiner.addSuite('testCompletion2', require('./testCompletion2'));
  ...
  examiner.addSuite('testKeyboard5', require('./testKeyboard5'));
  ...
  examiner.addSuite('testRemoteXhr', require('./testRemoteXhr'));
  // Loading 2 different remoting systems at a time breaks
  //examiner.addSuite('testRemoteWs', require('./testRemoteWs'));
  ...
  examiner.addSuite('testUnion', require('./testUnion'));
  examiner.addSuite('testUrl', require('./testUrl'));
};
