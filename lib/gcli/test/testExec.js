    ...
    },
    {
      ...
      check: {
        ...
        args: {
          ...
          optionValue: {
            value: '10', // Key part: this should be a string
            arg: ' 10',
            status: 'VALID',
            message: ''
          }
    ...
    },
    {
      ...
      check: {
        ...
        args: {
          ...
          optionValue: {
            value: 10, // Key part: this should be a number
            arg: ' 10',
            status: 'VALID',
            message: ''
          }
  ...
  return helpers.audit(options, [
    {
      ...
      exec: {
        output: /^Exec: tse node=\[object Object\], nodes=\[object (Object|NodeList)\], nodes2=\[object (Object|NodeList)\]$/
      },
      post: function() {
