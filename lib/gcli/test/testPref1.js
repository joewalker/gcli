...
exports.shutdown = function(options) {
  if (!options.isFirefox) {
    mockSettings.shutdown(options);
  }
};

function shouldContinuePrefTests(options) {
  ...
  if (options.isRemote) {
    assert.log('Skipping test; No remote delgate types.');
    return false;
  }
...
exports.testPrefShowStatus = function(options) {
  if (!shouldContinuePrefTests(options)) {
    return;
  }
