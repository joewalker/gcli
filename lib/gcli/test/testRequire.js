...
exports.testWorking = function(options) {
  ...
  var requireable = require('../test/requirable');
...
exports.testDomains = function(options) {
  ...
  if (define.Domain) {
    ...
    var requireable2 = domain.require('../test/requirable');
...
exports.testMultiImport = function(options) {
  var r1 = require('../test/requirable');
  var r2 = require('../test/requirable');
  assert.is(r1, r2);
};
...
exports.testUncompilable = function(options) {
  ...
  if (define.Domain) {
    try {
      var unrequireable = require('../test/unrequirable');
      t.fail();
    }
    catch (ex) {
      console.error(ex);
...
exports.testRecursive = function(options) {
  // See Bug 658583
  /*
  var recurse = require('../test/recurse');
  */
};
