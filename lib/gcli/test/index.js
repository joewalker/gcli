...
var originalCreateDisplay = exports.createDisplay;
...
exports.createDisplay = function(options) {
  return originalCreateDisplay(options).then(function(terminal) {
    var requisition = terminal.requisition;

    window.createDebugCheck = function() {
      require([ 'gcli/test/helpers' ], function(helpers) {
    ...
    window.testCommands = function() {
      require([ 'gcli/test/mockCommands' ], function(mockCommands) {
        mockCommands.setup();
      });
    };
