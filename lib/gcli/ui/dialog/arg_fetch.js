...
var argFetchCss = require('text!gcli/ui/dialog/arg_fetch.css');
var argFetchHtml = require('text!gcli/ui/dialog/arg_fetch.html');
...
function ArgFetcher(options, components) {
  ...
  this.terminal.onInputChange.add(this.inputChanged, this);
  this.inputChanged();
}
...
ArgFetcher.prototype.destroy = function() {
  this.terminal.onInputChange.remove(this.inputChanged, this);
...
ArgFetcher.prototype.getInputFor = function(assignment) {
  try {
    ...
    this.requisition.onTextChange.add(function() {
      newField.setConversion(assignment.conversion);
    }, this);
