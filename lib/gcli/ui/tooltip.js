...
function Tooltip(options) {
  ...
  if (tooltipCss != null) {
    this.style = util.dom.importCss(tooltipCss, this.document);
  }

  this.template = util.dom.toDom(this.document, tooltipHtml);
...
Tooltip.prototype.onAssignmentChange = function(ev) {
  if (this.assignment) {
    this.assignment.assignmentChange.remove(this.onAssignmentValueChange, this);
  }
  ...
  if (this.field) {
    this.field.destroy();
    this.field.fieldChanged.remove(this.onFieldChange, this);
  }
