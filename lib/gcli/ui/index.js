...
function createView(options) {
    ...
    var inputter = new ui.Inputter(requ, options);
    var doc = options.document || inputter.doc;

    var hinter = options.hinter || new ui.Hinter(doc, requ, options);
    var requestsView = new ui.RequestsView(doc, requ, inputter);
    var popup = new ui.Popup(doc, {
        inputter: inputter,
        style: Popup.style.doubleColumnFirstFixedLeft,
        children: [ hinter, requestsView ]
    });
