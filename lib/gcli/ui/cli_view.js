...
function CliView(options) {
    ...
    this.inputter = new Inputter(this.requ, options);

    this.element = this.inputter.element;

    this.doc = options.document || this.inputter.doc;
...
CliView.prototype = {
    ...
    /**
     * Bypass the input field and execute a string
     */
