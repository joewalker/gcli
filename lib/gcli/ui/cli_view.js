...
CliView.prototype = {
    ...
    createElements: function() {
        ...
        var showOutput = this.showOutput.bind(this);
        var hideOutput = this.hideOutput.bind(this);
        var preventBlur = this.preventBlur.bind(this);
        ...
        event.addListener(this.element, "focus", showOutput);
        event.addListener(this.element, "blur", hideOutput);
