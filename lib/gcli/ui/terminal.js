...
function Terminal(options, components) {
  ...
  this.terminalTemplate = util.toDom(this.document, terminalHtml);
  domtemplate.template(this.terminalTemplate, this, { stack: 'display.html' });
  while (this.terminalTemplate.hasChildNodes()) {
    this.rootElement.appendChild(this.terminalTemplate.firstChild);
  }
  ...
  this.outputViewTemplate = util.toDom(this.document, outputViewHtml);
...
Terminal.prototype.destroy = function() {
  ...
  this.terminalTemplate = undefined;
 ...
 */
Terminal.prototype.setHeight = function(height) {
...
function OutputView(output, terminal) {
  ...
  this.terminal.outputElement.appendChild(this.elems.rowin);
  this.terminal.outputElement.appendChild(this.elems.rowout);
