 ...
 */
Terminal.prototype.switchLanguage = function(LanguageCtor) {
  if (this.language != null) {
    this.language.destroy();
  }

  this.language = new LanguageCtor({
    terminal: this,
    focusManager: this.focusManager,
    outputViewTemplate: this.outputViewTemplate,
...
Terminal.prototype.handleKeyUp = function(ev) {
  ...
  if (ev.keyCode === KeyEvent.DOM_VK_RETURN) {
    return this.language.handleReturn().then(function(handled) {
      if (!handled) {
        this._scrollingThroughHistory = false;
