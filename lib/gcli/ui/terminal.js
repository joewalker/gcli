...
Terminal.prototype._init = function(components, terminalCss, terminalHtml) {
  ...
  this.control = new CommandControl(this, components.requisition);
  ...
  this.control.assignmentChanged();
};
...
Terminal.prototype._processCaretChange = function(input) {
  ...
  this.control._checkAssignment(start);
...
Terminal.prototype.handleKeyUp = function(ev) {
  ...
  if (ev.keyCode === KeyEvent.DOM_VK_UP) {
    return this.control.handleUpArrow();
  }

  if (ev.keyCode === KeyEvent.DOM_VK_DOWN) {
    return this.control.handleDownArrow();
  }
 ...
 */
Terminal.prototype.setChoice = function(choice) {
  this._choice = choice;
  this.updateCompletion();

  if (this.field && this.field.setChoiceIndex) {
    var conversion = this.assignment.conversion;
    return conversion.constrainPredictionIndex(this._choice).then(function(choice) {
...
Terminal.prototype._getCompleterTemplateData = function() {
  ...
  return this.requisition.getStateData(start, this._choice).then(function(data) {
