...
Prompt.prototype.resized = function(ev) {
  this.promptElement.style.top = ev.top + 'px';
  this.promptElement.style.height = ev.height + 'px';
  this.promptElement.style.left = ev.left + 'px';
  this.promptElement.style.width = ev.width + 'px';
};
