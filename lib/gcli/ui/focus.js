...
var eagerHelperSettingSpec = {
  name: 'devtools.gcli.eagerHelper',
  type: {
    name: 'selection',
    lookup: [
...
function FocusManager(options) {
  ...
  this._slowTypingDelay = options.slowTypingDelay || 1500;
  ...
  this._document.addEventListener('focus', this._onDocumentFocus, true);

  eagerHelper.onChange.add(this.onEagerHelperChange, this);
...
FocusManager.prototype.destroy = function() {
  eagerHelper.onChange.remove(this.onEagerHelperChange, this);

  this._document.removeEventListener('focus', this._onDocumentFocus, true);
  delete this._onDocumentFocus;
 ...
 * to lose focus
 */
FocusManager.prototype._onDocumentFocus = function() {
...
/**
 * Forcing a close open on the tooltip is a great way to reset it.
 */
FocusManager.prototype.onEagerHelperChange = function() {
  this._checkShow();
};
