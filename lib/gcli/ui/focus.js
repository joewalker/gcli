...
/**
 * l10n isn't always ready at initial load time, so delay until it's used
 */
Object.defineProperty(exports.items[0].description, 'object', {
  get: function() { return l10n.lookup('eagerHelperDesc'); },
  enumerable: true
});
