...
function Display(options) {
  ...
  if (!options.tooltip) {
    options.tooltip = new Tooltip(options);
  }
  ...
  this.focusManager.onFocus.add(this.tooltip.show, this.tooltip);
  this.focusManager.onBlur.add(this.tooltip.hide, this.tooltip);
