...
exports.createView = function(options) {
  ...
  var inputter = new Inputter(options, {
    ...
    element: findElement(doc, options.inputElement, 'gcli-input')
  });
  ...
  if (elementCreated && !options.dontDecorate) {
    completer.decorate(options.inputBackgroundElement || completeElement);
  }
