...
function BooleanField(doc, type, named, name, requ) {
    ...
    this.element.fieldChanged.add(this.onFieldChange, this);
}
...
BooleanField.prototype.destroy = function() {
    this.element.fieldChanged.remove(this.onChange, false);
};
...
SelectionField.prototype.destroy = function() {
    this.element.fieldChanged.remove(this.onChange, this);
};
