...
ArgFetcher.prototype.destroy = function() {
  this.inputter.onInputChange.remove(this.onInputChange, this);
 ...
 */
ArgFetcher.prototype.onInputChange = function() {
