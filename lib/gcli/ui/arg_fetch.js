...
function ArgFetcher(options) {
  ...
  if (editorCss != null) {
    this.style = util.importCss(editorCss, this.document);
  }

  this.template = util.toDom(this.document, argFetchHtml);
  this.templateOptions = { allowEval: true, stack: 'arg_fetch.html' };

  this.requisition.onCommandChange.add(this.onCommandChange, this);
...
ArgFetcher.prototype.destroy = function() {
  ...
  this.requisition.onCommandChange.remove(this.onCommandChange, this);
