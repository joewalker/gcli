...
Completer.prototype._getCompleterTemplateData = function() {
  ...
  var data = this.requisition.getStateData(input.typed, start, this.choice);
  ...
  // Convert space to &nbsp; in the string member (for HTML display) and status
  // to an appropriate class name (i.e. lower cased, prefixed with gcli-in-)
