...
function SelectionField(type, options) {
  ...
  Q.resolve(this.type.getLookup()).then(function(lookup) {
...
SelectionTooltipField.prototype.itemClicked = function(ev) {
  Q.resolve(this.type.parse(ev.arg)).then(function(conversion) {
...
SelectionTooltipField.prototype.onInputChange = function(ev) {
  ...
  Q.resolve(this.getConversion()).then(function(conversion) {
    this.onFieldChange({ conversion: conversion });
    this.setMessage(conversion.message);
  }.bind(this), console.error);
};
