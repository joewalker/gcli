...
function StringField(type, options) {
  ...
  this.element = util.dom.createElement(this.document, 'input');
  ...
  this.fieldChanged = util.createEvent('StringField.fieldChanged');
}
...
function NumberField(type, options) {
  ...
  this.fieldChanged = util.createEvent('NumberField.fieldChanged');
}
...
function BooleanField(type, options) {
  ...
  this.fieldChanged = util.createEvent('BooleanField.fieldChanged');
}
...
function DeferredField(type, options) {
  ...
  this.element = util.dom.createElement(this.document, 'div');
  this.update();

  this.fieldChanged = util.createEvent('DeferredField.fieldChanged');
}
...
DeferredField.prototype.update = function() {
  ...
  util.dom.clearElement(this.element);
...
function ArrayField(type, options) {
  ...
  this.addButton = util.dom.createElement(this.document, 'button');
  ...
  this.container = util.dom.createElement(this.document, 'div');
  this.container.classList.add('gcli-array-members');
  this.element.appendChild(this.container);

  this.onInputChange = this.onInputChange.bind(this);

  this.fieldChanged = util.createEvent('ArrayField.fieldChanged');
}
...
ArrayField.prototype.setConversion = function(conversion) {
  ...
  util.dom.clearElement(this.container);
  this.members = [];
...
ArrayField.prototype._onAdd = function(ev, subConversion) {
  ...
  var element = util.dom.createElement(this.document, 'div');
  ...
  var delButton = util.dom.createElement(this.document, 'button');
