...
exports.method = function(func, spec) {
  ...
  if (spec.request != null) {
    Object.keys(spec.request).forEach(name => {
      const arg = spec.request[name];
  ...
  return function(data) {
    const args = (data == null) ?
               [] :
               argSpecs.map(name => data[name]);
    return func.apply(this, args);
  };
};

const Arg = exports.Arg = function(index, type) {
  if (this == null) {
...
const RetVal = exports.RetVal = function(type) {
  if (this == null) {
