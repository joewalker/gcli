...
exports.connect = function(options) {
  ...
  GcliFront.create(connector, options.url).then(function(front) {
    front.on('commandsChanged', function(specs) {
      exports.addItems(system, specs, front);
    });
...
exports.addItems = function(system, specs, front) {
  exports.removeRemoteItems(system, front);
  var remoteItems = exports.addLocalFunctions(specs, front);
 ...
 */
exports.addLocalFunctions = function(specs, front) {
  ...
  specs.forEach(function(commandSpec) {
    ...
    if (!commandSpec.isParent) {
      commandSpec.exec = function(args, context) {
        ...
        return front.execute(data).then(function(reply) {
 ...
 */
exports.removeRemoteItems = function(system, front) {
