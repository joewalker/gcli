...
/**
 * basicTypes is an array of basic types that we'll need everywhere, even in a
 * setup that remotes everything
 */
var basicTypes = [
...
/**
 * clientItems is an array of items that are needed in most client setups
 */
var clientItems = [
