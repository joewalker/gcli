...
Remoter.prototype.addListener = function(action) {
  var listener = {
    action: action,
    caller: function() {
      action('commandsChanged', this.requisition.commands.getCommandSpecs());
    }.bind(this)
  };
  this._listeners.push(listener);

  this.requisition.commands.onCommandsChange.add(listener.caller);
};
...
Remoter.prototype.removeListener = function(action) {
  ...
  this.requisition.commands.onCommandsChange.remove(listener.caller);
};
...
Remoter.prototype.exposed = {
  ...
  specs: method(function() {
    return this.requisition.commands.getCommandSpecs();
  }, {
    request: {},
  ...
  selectioninfo: method(function(commandName, paramName, action) {
    var command = this.requisition.commands.get(commandName);
    if (command == null) {
