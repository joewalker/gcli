...
exports.addListener = function(context, action) {
  ...
  var listener = {
    ...
    caller: function() {
      action('canonChanged', {
        commands: canon.getCommandSpecs(),
        types: []
      });
    }
  };
...
exports.exposed = {
  ...
  /**
   * A proxy to call dynamically registered functions
   */
  call: function(context, data) {
   return util.callHandle(context, data.id, data.args);
  },
