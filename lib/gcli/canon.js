 ...
 */
exports.addCommand = function addCommand(commandSpec) {
 ...
 */
exports.removeCommand = function removeCommand(commandOrName) {
 ...
 */
exports.getCommand = function getCommand(name) {
 ...
 */
exports.getCommandNames = function getCommandNames() {
 ...
 */
exports.getCommandSpecs = function getCommandSpecs() {
  return commandSpecs;
};
 ...
 */
exports.addProxyCommands = function(prefix, commandSpecs, remoter) {
  ...
  names.forEach(function(name) {
    ...
    commandSpec.exec = function(args, context) {
      context.commandName = commandSpec.name;
      remoter(args, context);
    }.bind(this);

    commandSpec.name = prefix + ' ' + commandSpec.name;
    exports.addCommand(commandSpec);
  }.bind(this));
};
 ...
 */
exports.onCanonChange = util.createEvent('canon.onCanonChange');
