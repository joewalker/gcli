...
function Command(commandSpec) {
  ...
  this.description = this._lookupDescription();
 ...
 */
Command.prototype._lookupDescription = function() {
  if (typeof this.description === 'string') {
    return this.description;
  }
  if (!this.description) {
    return l10n.lookup('canon_desc_none');
  }
  if (typeof this.description === 'object') {
    if (this.description.key) {
      return l10n.lookup(this.description.key);
    }
    var locales = l10n.getPreferredLocales();
    var translated;
    locales.some(function(locale) {
      translated = this.description[locale];
