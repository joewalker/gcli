 ...
 */
var prefsConverterSpec = {
  from: 'settingsData',
  to: 'view',
  exec: function(settingsData, conversionContext) {
    var prefList = new PrefList(settingsData, conversionContext);
...
exports.startup = function(excludeList) {
  converters.addConverter(prefsConverterSpec);
  canon.addCommand(prefListCmdSpec);
};

exports.shutdown = function() {
  canon.removeCommand(prefListCmdSpec);
  converters.removeConverter(prefsConverterSpec);
};
 ...
 */
function PrefList(settingsData, conversionContext) {
  this.search = settingsData.search;
