...
help.onFirstUseStartup = function(document) {
  if (!helpIntroTemplate) {
    helpIntroTemplate = util.dom.toDom(document, helpIntroHtml);
  }
  if (!helpListTemplate) {
    helpListTemplate = util.dom.toDom(document, helpListHtml);
  }
  if (!helpManTemplate) {
    helpManTemplate = util.dom.toDom(document, helpManHtml);
  }
