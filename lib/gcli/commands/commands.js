 ...
 */
Canon.prototype.add = function(commandSpec) {
  if (this._commands[commandSpec.name] != null) {
    // Roughly canon.remove() without the event call, which we do later
...
/**
 * Remove an individual command. The opposite of Canon.add().
 ...
 */
Canon.prototype.remove = function(commandOrName) {
  ...
  // See start of canon.add if changing this code
 ...
 */
Canon.prototype.get = function(name) {
 ...
 */
Canon.prototype.getAll = function() {
