...
var xhrsocket = {
  init: function(app, context) {
    ...
    Object.keys(remoted.exposed).forEach(function(command) {
      app.use('/' + command, function(req, res) {
        var reply = remoted.exposed[command](context, req.body);
...
var websocket = {
  init: function(server, context) {
    ...
    this._io.sockets.on('connection', function(socket) {
      ...
      remoted.addListener(context, function(name, data) {
      ...
      Object.keys(remoted.exposed).forEach(function(command) {
        socket.on(command, function(request) {
          try {
            var reply = remoted.exposed[command](context, request.data);
