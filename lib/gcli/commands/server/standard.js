...
exports.items = [
  {
    ...
    exec: function(args, context) {
      let log = 'Building standard outputs to built/gcli[-uncompressed].js\n';

      copy.mkdirSync(path.dirname(require.main.filename) + '/built', 493 /*0755*/);
      const project = copy.createCommonJsProject({
        roots: [ path.dirname(require.main.filename) + '/lib' ]
      });
      const sources = copy.createDataObject();
