 ...
 */
function ConnectionType(typeSpec) {
}

ConnectionType.prototype = new SelectionType({ cacheable: false });

ConnectionType.prototype.lookup = function() {
  return Object.keys(connections).map(function(prefix) {
    return { name: prefix, value: connections[prefix] };
  });
};

ConnectionType.prototype.name = 'connection';
...
exports.startup = function() {
  gcli.addType(ConnectionType);

  gcli.addCommand(connect);
  gcli.addCommand(disconnect);
};

exports.shutdown = function() {
  gcli.removeCommand(connect);
  gcli.removeCommand(disconnect);

  gcli.removeType(ConnectionType);
};
