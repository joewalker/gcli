...
var connect = {
  ...
  exec: function(args, context) {
    ...
    return args.method.connect(args.host, args.port).then(function(connection) {
      ...
      return connection.call('specs').then(function(specs) {
        ...
        canon.addProxyCommands(args.prefix, specs, remoter);
  ...
  createRemoter: function(prefix, connection) {
    return function(cmdArgs, context) {
      ...
      return connection.execute('command', data).then(function(reply) {
