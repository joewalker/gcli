...
exports.createEvent = function(name) {
  ...
  var event = function(ev) {
    if (eventDebug) {
      console.log('Fire: ' + name + ' to ' + handlers.length + ' listeners');
    }
 ...
 */
exports.setInnerHtml = function(elem, html) {
  if (exports.isXmlDocument(elem.ownerDocument)) {
    try {
      exports.clearElement(elem);
      html = '<div xmlns="' + exports.NS_XHTML + '">' + html + '</div>';
