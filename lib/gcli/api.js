...
exports.getApi = function() {
  ...
  var api = {
    addCommand: function(item) { canon.addCommand(item); },
    removeCommand: function(item) { canon.removeCommand(item); },
    ...
    addType: function(item) { types.addType(item); },
    removeType: function(item) { types.removeType(item); },
