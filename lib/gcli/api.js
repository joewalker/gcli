...
exports.getApi = function() {
  ...
  var addItem = function(item) {
    ...
    system[itemType].add(item);
  };

  var removeItem = function(item) {
    var itemType = item.item || item.prototype.item;
    system[itemType].remove(item);
  };
  ...
  Object.defineProperty(api, 'commands', {
    get: function() { return system.commands; },
    set: function(commands) { system.commands = commands; },
    enumerable: true
  });

  Object.defineProperty(api, 'types', {
    get: function() { return system.types; },
    set: function(types) {
      system.types = types;
      settings.startup(system.types);
    },
    enumerable: true
  });
