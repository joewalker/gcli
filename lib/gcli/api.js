...
exports.getApi = function() {
  ...
  return {
    addCommand: canon.addCommand.bind(canon),
    removeCommand: canon.removeCommand.bind(canon),
    ...
    addType: types.addType.bind(types),
    removeType: types.removeType.bind(types),
    ...
    addItems: function(items) {
      items.forEach(function(item) {
        ...
        if (type === 'command') {
          ...
          settings.addSetting(types, item);
        }
        else if (type === 'type') {
          types.addType(item);
        }
