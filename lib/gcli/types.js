...
NumberType.prototype.parse = function(arg) {
  ...
  if (isNaN(value)) {
    return new Conversion(this.getMin(), arg, Status.ERROR,
        l10n.lookupFormat('types_number_nan', [ arg.text ]));
  }

  if (this.getMax() != null && value > this.getMax()) {
    return new Conversion(value, arg, Status.ERROR,
        l10n.lookupFormat('types_number_max', [ value, this.getMax() ]));
  }

  if (value < this.getMin()) {
    return new Conversion(value, arg, Status.ERROR,
        l10n.lookupFormat('types_number_min', [ value, this.getMin() ]));
  }
...
SelectionType.prototype.parse = function(arg) {
  ...
  return new Conversion(null, arg, Status.ERROR,
      l10n.lookupFormat('types_selection_nomatch', [ arg.text ]));
};
