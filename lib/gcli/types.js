...
NumberType.prototype.parse = function(arg) {
  ...
  if (isNaN(value)) {
    return new Conversion(this.getMin(), arg, Status.ERROR,
  ...
  if (this.getMax() != null && value > this.getMax()) {
    return new Conversion(value, arg, Status.ERROR,
        l10n.lookup('types_number_max', { value: value, max: this.getMax() }));
  }

  if (value < this.getMin()) {
    return new Conversion(value, arg, Status.ERROR,
        l10n.lookup('types_number_min', { value: value, max: this.getMin() }));
  }
