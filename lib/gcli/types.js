 ...
 */
Types.prototype.getTypeSpecs = function() {
  var specs = {};

  Object.keys(this._registered).forEach(function(name) {
    var type = this._registered[name];
    if (!type.noRemote) {
      specs[name] = {
        name: name,
        parent: 'remote'
 ...
 */
Types.prototype.addProxyTypes = function(typeSpecs, remoter, prefix, to) {
  var names = Object.keys(typeSpecs);

  names.forEach(function(name) {
    var typeSpec = typeSpecs[name];

    if (typeSpec.noRemote) {
      return;
    }
