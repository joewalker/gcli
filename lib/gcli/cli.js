 ...
 * @param typed The current input text
 * @param start The location of the cursor
 * @param choice The index of the chosen prediction
 ...
 *   directTabText.
 */
Requisition.prototype.getStateData = function(typed, start, choice) {
  ...
  if (typed.trim().length !== 0) {
    predictionPromise = current.getPredictionAt(choice);
  }
