...
function Requisition(environment, doc, commandOutputManager) {
  ...
  this.executionContext = exports.createExecutionContext(this);
  this.conversionContext = exports.createConversionContext(this);
...
Requisition.prototype._split = function(args) {
  ...
  while (argsUsed <= args.length) {
    ...
    conversion = util.synchronize(commandType.parse(arg, this.executionContext));
...
exports.createExecutionContext = function(requisition) {
  ...
  Object.defineProperty(context, 'typed', {
   ...
   * Do not use it
   */
  Object.defineProperty(context, '__dlhjshfw', {
    get: function() { return requisition; },
    enumerable: false
  });

  if (legacy) {
    context.createView = view.createView;
    context.document = requisition.document;
    context.exec = requisition.exec.bind(requisition);
    context.update = requisition.update.bind(requisition);
    context.updateExec = requisition.updateExec.bind(requisition);

    /**
     * @deprecated Use defer() instead, which does the same thing, but is not
     * confusingly named
     */
    context.createPromise = function() {
      return Promise.defer();
    };
  }
 ...
 * Functions and data related to the execution of a command
 */
exports.createConversionContext = function(requisition) {
  var context = {
    defer: function() {
      return Promise.defer();
    },
