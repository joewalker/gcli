...
var centralCanon = require('./canon').centralCanon;
...
function getEvalCommand() {
  if (getEvalCommand._cmd == null) {
    getEvalCommand._cmd = centralCanon.getCommand(evalCmd.name);
  }
...
Requisition.prototype.exec = function(options) {
  ...
  if (options) {
    ...
    if (options.command != null) {
      ...
      command = centralCanon.getCommand(options.command);
      if (!command) {
