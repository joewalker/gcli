...
var Parameter = require('./canon').Parameter;
...
function CommandAssignment() {
  ...
  this.param = new Parameter(commandParamMetadata);
}
...
Requisition.prototype.clear = function() {
  ...
  var conversion = commandModule.parse(arg, false);
...
Requisition.prototype._split = function(args) {
  ...
  while (argsUsed <= args.length) {
    ...
    if (this.prefix != null && this.prefix !== '') {
      ...
      conversion = commandModule.parse(prefixedArg, false);
      if (conversion.value == null) {
        conversion = commandModule.parse(arg, false);
      }
    }
    else {
      conversion = commandModule.parse(arg, false);
