...
Requisition.prototype.destroy = function() {
  ...
  delete this.inputChange;
  delete this.commandChange;
  delete this.assignmentChange;
  delete this.commandOutputManager;

  delete this._unassigned;
  delete this._args;
  delete this._assignments;
  delete this.commandAssignment;
