...
function Requisition(environment, doc) {
  ...
  this.setAssignmentBlank(this.commandAssignment);
...
Requisition.prototype._commandAssignmentChanged = function(ev) {
  ...
  if (command) {
    for (var i = 0; i < command.params.length; i++) {
      ...
      this.setAssignmentBlank(assignment);
...
/**
 * Reset an assignment to its default values
 */
Requisition.prototype.setAssignmentBlank = function(assignment) {
  assignment.setConversion(assignment.param.type.getBlank());
};
