...
var i18n = {
  root: {
    ...
    // developer too command lines. This describes the '{' command.
    ...
    // the is not properly terminated, this error message is displayed.
    ...
    // When the command line is expecting a CSS string that matches a single
    // node, but no one nodes match, this error message is displayed.
