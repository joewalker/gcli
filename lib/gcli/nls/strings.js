...
var i18n = {
  root: {
    ...
    connectDesc: 'Connect to a remote system',

    // A fuller description of the 'connect' command.
    // Displayed when the user asks for help on what it does.
    connectManual: '',

    // A short description of the 'name' parameter to the 'connect' command.
    // See connectNameManual for a fuller description of what it does.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    connectNameDesc: 'Short system name',

    // A fuller description of the 'name' parameter to the 'connect' command.
    // Displayed when the user asks for help on what it does.
    connectNameManual: 'A short name for the URL that we connect to.',

    // A short description of the 'url' parameter to the 'connect' command.
    // See connectUrlManual for a fuller description of what it does.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    connectUrlDesc: 'URL to connect to',

    // A fuller description of the 'url' parameter to the 'connect' command.
    // Displayed when the user asks for help on what it does.
    connectUrlManual: 'The URL to connect to for example \'http://localhost\''
  }
};
