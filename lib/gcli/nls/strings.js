...
var i18n = {
  root: {
    ...
    // Error message given when a file argument points to a non-file,
    // when a directory is needed (e.g. for use with 'cd')
    // %1$S is a filename
    ...
    // When the command line is passed a date, however the input string is
    // not a valid date, this error message is displayed.
    typesDateNan: 'Can\'t convert "%S" to a date.',

    // When the command line is passed a date, but the number is later than
    // the latest allowed date, this error message is displayed.
    typesDateMax: '%1$S is later than maximum allowed: %2$S.',

    // When the command line is passed a date, but the date is earlier than
    // the earliest allowed number, this error message is displayed.
    ...
    // See description of 'helpManRequired'. %1$S is the default value
    ...
    // A very short description of the 'context' command.
    // This string is designed to be shown in a menu alongside the command name,
    // which is why it should be as short as possible.
    // See contextManual for a fuller description of what it does.
    contextDesc: 'Concentrate on a group of commands',

    // A fuller description of the 'context' command.
    // Displayed when the user asks for help on what it does.
    ...
    // A short description of the 'prefix' parameter to the 'context' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    contextPrefixDesc: 'The command prefix',

    // An error message displayed during the processing of the 'context'
    ...
    // A message displayed during the processing of the 'context' command, to
    // indicate success.
    contextReply: 'Using %1$S as a command prefix',

    // A message displayed during the processing of the 'context' command, to
    // indicate that there is no command prefix
    contextEmptyReply: 'Command prefix is unset',

    // A very short description of the 'connect' command.
    // This string is designed to be shown in a menu alongside the command name,
    // which is why it should be as short as possible.
    // See connectManual for a fuller description of what it does.
    connectDesc: 'Proxy commands to server',

    // A fuller description of the 'connect' command.
    // Displayed when the user asks for help on what it does.
    ...
    // A short description of the 'prefix' parameter to the 'connect' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    connectPrefixDesc: 'Parent prefix for imported commands',

    // A short description of the 'port' parameter to the 'connect' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    connectPortDesc: 'The TCP port to listen on',

    // A short description of the 'host' parameter to the 'connect' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    connectHostDesc: 'The hostname to bind to',

    // An error condition from executing the 'connect' command
    ...
    // A very short description of the 'disconnect' command.
    // This string is designed to be shown in a menu alongside the command name,
    // which is why it should be as short as possible.
    // See connectManual for a fuller description of what it does.
    disconnectDesc: 'Proxy commands to server',

    // A fuller description of the 'disconnect' command.
    // Displayed when the user asks for help on what it does.
    ...
    // A short description of the 'prefix' parameter to the 'disconnect' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    ...
    // This string is designed to be shown in a menu alongside the command name,
    // which is why it should be as short as possible.
    // See cdManual for a fuller description of what it does.
    cdDesc: 'Change working directory',

    // A fuller description of the 'cd' command.
    // Displayed when the user asks for help on what it does.
    cdManual: 'Change the current working directory as used by the exec command',

    // A short description of the 'directory' parameter to the 'cd' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    cdDirectoryDesc: 'The new working directory',

    // The output from execution of the 'cd' command
    cdOutput: 'Working directory is now %S',

    // A very short description of the 'exec' command.
    // This string is designed to be shown in a menu alongside the command name,
    // which is why it should be as short as possible.
    // See execManual for a fuller description of what it does.
    execDesc: 'Execute a system command',

    // A fuller description of the 'exec' command.
    // Displayed when the user asks for help on what it does.
    execManual: '',

    // A short description of the 'command' parameter to the 'exec' command.
    // This string is designed to be shown in a dialog with restricted space,
    // which is why it should be as short as possible.
    ...
    // This is used to show the preference name and the associated preference
    // value. %1$S is replaced with the preference name and %2$S is replaced
    ...
    // asks for help on the settings. eagerHelper allows users to select between
    // showing no tooltips, permanent tooltips, and only important tooltips
