...
/**
 * Inform progress handlers of progress
 * @param aData The value to pass to handlers.
 * @return |this|
 */
Promise.prototype.progress = function(aData) {
  this._onProgressHandlers.forEach(function(handler) {
    handler.call(null, aData);
  });
  return this;
};
 ...
 * Progress handlers are informed whenever |this.progress| is called.
 * Progress is not propagated among promises.
 * @param aHandler A function to inform in case of progress.
 * @return |this|
 */
Promise.prototype.onProgress = function(aHandler) {
  if (typeof aHandler == "function") {
    this._onProgressHandlers.push(aHandler);
  }
  return this;
};
