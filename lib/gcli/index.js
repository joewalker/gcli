...
gcli.createView = require('gcli/ui/cli_view').createView;
gcli.Requisition = require('gcli/cli').Requisition;
...
gcli.startup = function() {
    ...
    require('gcli/commands/basic').startup();

    require('gcli/cli').startup();
    require('gcli/ui/field').startup();

    require('gcli/test/testCli').testAll();
};
...
gcli.shutdown = function() {
    ...
    require('gcli/commands/basic').shutdown();
