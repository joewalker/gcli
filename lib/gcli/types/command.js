...
exports.items = [
  ...
  },
  {
    ...
    allowNonExec: true,
    lookup: function() {
      return exports.getCommandLookup();
    },

    parse: function(arg, context) {
      var conversion = exports.parse(arg, this.allowNonExec);
...
exports.parse = function(arg, allowNonExec) {
  var lookup = exports.getCommandLookup();
  var predictions = exports.findPredictions(arg, lookup);
  return exports.convertPredictions(arg, allowNonExec, predictions);
};

exports.getCommandLookup = function() {
...
exports.convertPredictions = function(arg, allowNonExec, predictions) {
