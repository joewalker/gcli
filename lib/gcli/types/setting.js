...
exports.items = [
  ...
  },
  {
    ...
    delegateType: function(context) {
      if (context != null) {
        const setting = context.getArgsObject()[this.settingParamName];
        if (setting != null) {
          return setting.type;
        }
      }
