...
DateType.prototype.stringify = function(value) {
  ...
  var timePos = str.indexOf('23:00:00.000');
  if (timePos == -1) {
    timePos = str.indexOf('00:00:00.000');
  }

  if (timePos != -1) {
    // This looks like a plain date without a time component; remove the time
    str = str.substr(0, timePos - 1);
  }
