...
exports.items = [
  {
    ...
    parse: function(arg, context) {
      // Try to parse the given argument in the provided order of alternative
      // types. Returns a promise containing the best conversion value.
      // If none of the conversions are VALID we return the best INCOMPLETE
      var bestIncomplete;

      var onError = function(i) {
        if (i >= this.alternatives.length) {
          if (bestIncomplete != null) {
            return Promise.resolve(bestIncomplete);
          }
