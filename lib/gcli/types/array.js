...
const ArrayConversion = require('./types').ArrayConversion;
const ArrayArgument = require('./types').ArrayArgument;
...
exports.items = [
  {
    ...
    parse: function(arg, context) {
      ...
      const conversionPromises = arg.getArguments().map(subArgParse);
      return Promise.all(conversionPromises)
                    .then(conversions => new ArrayConversion(conversions, arg));
    },
