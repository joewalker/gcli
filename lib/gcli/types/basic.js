...
StringType.prototype.parse = function(arg) {
  if (arg.text == null || arg.text === '') {
    return Q.resolve(new Conversion(undefined, arg, Status.INCOMPLETE, ''));
  }
  return Q.resolve(new Conversion(arg.text, arg));
};
...
NumberType.prototype.parse = function(arg) {
  ...
  if (isNaN(value)) {
    ...
    return Q.resolve(new Conversion(undefined, arg, Status.ERROR, message));
  }
  ...
  return Q.resolve(new Conversion(value, arg));
};
...
BooleanType.prototype.parse = function(arg) {
  if (arg.type === 'TrueNamedArgument') {
    return Q.resolve(new Conversion(true, arg));
  }
  if (arg.type === 'FalseNamedArgument') {
    return Q.resolve(new Conversion(false, arg));
  }
...
function DelegateType(typeSpec) {
  if (typeof typeSpec.defer !== 'function') {
    throw new Error('Instances of DelegateType need typeSpec.defer to be a function that returns a type');
  }
 ...
 */
DelegateType.prototype.defer = function() {
...
BlankType.prototype.parse = function(arg) {
  return Q.resolve(new Conversion(undefined, arg));
};
...
ArrayType.prototype.parse = function(arg) {
  ...
  var subArgParse = function(subArg) {
    return Q.resolve(this.subtype.parse(subArg)).then(function(conversion) {
