...
var Argument = require('./types').Argument;

function conversionToJson(conversion) {
  return promise.resolve(conversion.predictions).then(function(predictions) {
    return {
...
function jsonToConversion(json, arg) {
...
exports.items = [
  // A type for "we don't know right now, but hope to soon"
  {
    ...
    getSpec: function() {
      return {
        ...
        parseHandle: util.getHandle(this.parseToJson, this),
      };
    },
    ...
    parseToJson: function(arg, context) {
      return this.parse(arg, context).then(conversionToJson);
    },
  ...
  },
  {
    ...
    parse: function(arg, context) {
      return util.callRemoteHandle(this.connection, this.parseHandle,
                                   [ arg, context ]).then(function(data) {
        return jsonToConversion(data, arg);
      });
    },
