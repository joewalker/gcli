...
SelectionType.prototype.getSpec = function() {
  ...
  if (this.lookup != null) {
    spec.lookup = (typeof this.lookup === 'function') ?
                  util.getRemoteHandle(this.lookup, this) :
                  this.lookup;
  }
  if (this.data != null) {
    spec.data = (typeof this.data === 'function') ?
                util.getRemoteHandle(this.data, this) :
                this.data;
  }
...
SelectionType.prototype.getLookup = function(context) {
  ...
  if (typeof this.lookup === 'string') {
    reply = util.callRemoteHandle(this.lookup, context);
  }
    ...
    var fromRemote = util.callRemoteHandle(this.data, context);
    reply = resolve(fromRemote, context).then(this._dataToLookup);
  }
