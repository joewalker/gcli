...
SelectionType.prototype.getSpec = function() {
  var spec = { name: 'selection' };
  if (this.lookup != null) {
    spec.lookup = (typeof this.lookup === 'function') ?
                  util.getHandle(this.lookup, this) :
                  this.lookup;
  }
  if (this.data != null) {
    spec.data = (typeof this.data === 'function') ?
                util.getHandle(this.data, this) :
                this.data;
  }
...
SelectionType.prototype.getLookup = function(context) {
  ...
  if (typeof this.lookup === 'string') {
    remote = util.callRemoteHandle(this.connection, this.lookup, [ context ]);
    reply = resolve(remote, context);
  }
    ...
    remote = util.callRemoteHandle(this.connection, this.data, [ context ]);
    reply = resolve(remote, context).then(this._dataToLookup);
  }
