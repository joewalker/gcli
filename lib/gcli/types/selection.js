...
SelectionType.prototype.parse = function(arg) {
  ...
  if (predictions.length === 0) {
    ...
    return Q.resolve(new Conversion(undefined, arg, Status.ERROR, msg,
  ...
  if (predictions[0].name === arg.text) {
    ...
    return Q.resolve(new Conversion(value, arg, Status.VALID, '',
                          Q.resolve(predictions)));
  }
...
SelectionType.prototype.getBlank = function() {
  var predictFunc = function() {
    return Q.resolve(this.getLookup()).then(function(lookup) {
