...
SelectionType.prototype.getLookup = function() {
  ...
  var reply = this.lookup ?
      resolve(this.lookup) :
      resolve(this.data).then(dataToLookup);

  if (this.cacheable) {
    reply.then(function(lookup) {
      this._cachedLookup = lookup;
    }.bind(this));
  }
...
function resolve(thing) {
  return Q.resolve(thing).then(function(resolved) {
