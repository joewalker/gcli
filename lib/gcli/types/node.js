...
NodeType.prototype.parse = function(arg) {
  ...
  try {
    ...
    return Q.resolve(new Conversion(undefined, arg, Status.ERROR,
  ...
  if (nodes.length === 1) {
    ...
    return Q.resolve(new Conversion(node, arg, Status.VALID, ''));
  }
...
NodeListType.prototype.parse = function(arg) {
  ...
  host.flashNodes(nodes, false);
  return Q.resolve(new Conversion(nodes, arg, Status.VALID, ''));
};
